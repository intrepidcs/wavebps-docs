...
<table><thead><tr><th width="285">Type</th><th>Header</th></tr></thead><tbody><tr><td>Double Precision Floating Point</td><td>char szverion5 [] = {'w','a','v','e','b','p','s','5','0','0',0,0,0,0,0,0};</td></tr><tr><td>Unsigned Short (16 bits)</td><td>char szverion6 [] = {'w','a','v','e','b','p','s','6','0','0',0,0,0,0,0,0};</td></tr></tbody></table>
...
Follow this link for the [double precision floating point topic](double-precision-format.md).

Follow this link for the [unsigned short topic](unsigned-short-format.md).
