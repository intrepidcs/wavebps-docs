...
| ID     |                                                                                                                |                                                                                                                         |
| Node   | Name of the node sending this event (requires a data base)                                                     | When enabled with a data base this enables statistical [node analysis on automatic measurements](advanced-analysis.md). |
