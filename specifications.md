...
* [TCP/IP Server Text API](automated-test-with-wavebps.md) allows remote control of application via Windows Clients and Vehicle Spy Function Blocks&#x20;
* [Open DLL import support](loading-custom-data-into-wavebps.md) allowing importation of any waveform data from any source
* &#x20;[Export support for raw analog waveforms](exporting-waveforms-from-wavebps.md) including efficient binary formats ([fully open and documented](wbps-binary-file-format/)) and CSV for both entire waveform or subset of waveform&#x20;
* [Export](exporting-waveforms-from-wavebps.md) to [Vehicle Spy](https://intrepidcs.com/products/software/vehicle-spy/) buffer format&#x20;
* [Modification of waveform](exporting-waveforms-from-wavebps.md) within software to create improper waveforms for error testing with Arbitrary Waveform Generators&#x20;
* Import and Export WaveBPS XML configuration files
* &#x20;[Node Analysis](advanced-analysis.md) can prepare statistical analysis of all network nodes for all decoders and automatic measurements&#x20;
* [Acquisition Modes include Single, Multiple, and Filter Match Capture](live-capture-with-wavebps.md). Filter Match capture is a multiple capture that stops when there is a filter match.&#x20;
* [Automatic buffer capture mode](live-capture-with-wavebps.md) saves buffer every time a filter condition is matched&#x20;
* [Automatic Wave file playing](live-capture-with-wavebps.md) on a filter condition
* [Cursor Modes](cursor-measurements.md) allow measurement of : Delta Time in Second, Delta Time in Bits, Frequency, Delta Volts, Absolute Volts, and Bus Utilization&#x20;
* [High Resolution Cursor](cursor-measurements.md) allows very fine cursor control for measure across large captures&#x20;
* [Auto scroll waveform based](navigation.md) on Bit rate or Event with programmable rate&#x20;
* [Search, Browse and Filter](navigation.md) based on any automatic measurement&#x20;
* [Powerful Mouse wheel based](navigation.md) waveform navigation with optional knob
...
* [Database support](wavebps-basic-databases.md) with import from Vehicle Spy software (UEF, DBC, VS3, LDF, FIBEX, etc...)&#x20;
* [User specified Baud Rate](setting-up-serial-decoding-in-wavebps.md) and thresholds including inversion&#x20;
* [Decoder Templates](setting-up-serial-decoding-in-wavebps.md) allow multiple customizations of each decoder with a custom description&#x20;
* Supports [Math Operations](setting-up-serial-decoding-in-wavebps.md) on multiple channels (A-B, A+B, C-D, C+D)
...
* GMW3110 [Single Wire CAN / CAN FD HighSpeed mode](setting-up-serial-decoding-in-wavebps.md) transition decoding
* [Single Wire CAN / CAN FD High Voltage](setting-up-serial-decoding-in-wavebps.md) Threshold setting
* [User settable Bit tolerance](setting-up-serial-decoding-in-wavebps.md)
